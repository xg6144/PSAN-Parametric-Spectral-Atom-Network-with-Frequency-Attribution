...
evaluate_deit.py 기반, ConvNeXtV2 모델 재구성 로직 적용.
GRN + LayerNorm 구조의 ConvNeXtV2 backbone을 timm으로 빌드.

지원 backbone:
  convnextv2_atto, convnextv2_atto, convnextv2_pico,
  convnextv2_nano, convnextv2_tiny, convnextv2_small, convnextv2_base
"""
import sys
import os
import json
...
class EvalConfig:
    ...
    # checkpoint
    ckpt_path: str = "best_convnextv2_atto.pth"
    weight_source: str = "auto"  # "auto" | "eval_model" | "ema" | "model"

    # 출력
    output_dir: str = "eval_results"
    model_tag: str = "convnextv2_atto"
...
def build_model_from_ckpt_config(ckpt_cfg: Dict[str, Any], num_classes: int) -> nn.Module:
    backbone_name = ckpt_cfg.get("backbone_name", "convnextv2_atto")
...
if __name__ == "__main__":
    cfg = EvalConfig(
        ...
        ckpt_path="best_convnextv2_atto.pth",
        weight_source="auto",
