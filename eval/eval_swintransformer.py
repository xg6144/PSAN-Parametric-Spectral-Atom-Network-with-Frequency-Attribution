# eval_swintransformer.py
"""
Swin Transformer 평가 스크립트.

train_swintransformer.py 로 학습한 checkpoint (best_*.pth / last_*.pth)를
...
class EvalConfig:
    ...
    # checkpoint
    ckpt_path: str = "best_swin_tiny.pth"
...
def build_model_from_ckpt_config(ckpt_cfg: Dict[str, Any], num_classes: int) -> nn.Module:
    backbone_name = ckpt_cfg.get("backbone_name", "swin_tiny_patch4_window7_224")
